...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/hlhk2017/Surveillance-Station/main/9.2.0_11289/SurveillanceStation-x86_64/install_license)
```
...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/hlhk2017/Surveillance-Station/main/9.2.0_11289/license/remove_license)
```
---
### Cracked
![License](https://raw.githubusercontent.com/hlhk2017/Surveillance-Station/main/img/crack_license.png)
